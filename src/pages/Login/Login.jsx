            ...
            <div className="login-container">
                ...
                <form className="login-form" onSubmit={handleSubmit}>
                    ...
                    <div className="input-group">
                        ...
                        />
                        {fieldsError.username && <span className="error-message">{fieldsError.username}</span>}
                    </div>
                    <div className="input-group">
                        ...
                        />
                        {fieldsError.password && <span className="error-message">{fieldsError.password}</span>}
                    </div>
